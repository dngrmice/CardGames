...
## Technology
You must use React to write the game. It should be frontend driven.
You may save states using however you like.
You can load any packages you like.

## References
You can use any major references, such as reactjs.org, jquery.com, developer.mozilla.org, package documentation and so
on. You may not copy any similar public code.
